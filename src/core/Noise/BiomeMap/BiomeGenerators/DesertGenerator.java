 ...
 */
public class DesertGenerator extends NoiseSettings {
    
    BiomeSettings biomeSettings;
    NoiseFilter[] noiseFilters;
    
    public DesertGenerator (BiomeSettings biomeSettings)
    {
    ...
    private void initializeNoiseFilters() {
        ...
        noiseFilters[0].settings.baseRoughness = 0.00850f;
        noiseFilters[0].settings.roughness = 2.4f;
        noiseFilters[0].settings.strength = 0.0151f;
        noiseFilters[0].settings.numLayers = 8;
        noiseFilters[0].settings.persistance = 0.275f;
